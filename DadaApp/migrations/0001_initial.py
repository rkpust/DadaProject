    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embroidery', models.CharField(default='None', max_length=50, null=True)),
                ...
                ('first_row_from_brim', models.DecimalField(decimal_places=2, max_digits=4, null=True)),
                ('distance_from_front_end', models.DecimalField(decimal_places=2, max_digits=4, null=True)),
